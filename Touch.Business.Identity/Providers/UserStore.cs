...
namespace Touch.Providers
{
    ...
    {
        #region Dependencies
        public IIdentityUserLogic<TUser> IdentityUserLogic { protected get; set; }
        public IIdentityClaimLogic<TUser> IdentityClaimLogic { protected get; set; }
        public IIdentityRoleLogic<TUser> IdentityRoleLogic { protected get; set; }
        #endregion
